...
int main(int argc, char **argv)
{
    ...
    // Joint Goal (recommended for a 5-DOF arm: always reachable)

    std::vector<double> joints = { 0.0, 1.0, 1.0, 0.0, 0.0 };
    ...
    // // Pose Goal
    // // NOTE: a 5-DOF arm cannot reach an arbitrary 6-DOF pose.
    // // Only use poses that lie in the reachable workspace of the 5-DOF arm.
